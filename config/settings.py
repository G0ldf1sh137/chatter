...
MIDDLEWARE = [
    ...
    "accounts.middleware.ActivateUserTimezoneMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "posts.context_processors.unread_notifications",
...
# Max upload size for message image attachments, enforced in posts.forms.
MAX_MESSAGE_IMAGE_UPLOAD_SIZE = 5 * 1024 * 1024
